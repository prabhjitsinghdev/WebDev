 ...
 * 1.00       16-03-2026    Prabhjit Singh      mr_auto_advinterje_insertLine.js -- this one uses insert line logic instead (Creating advanced intercomapny JE) 
 * 
 * */
define([
    'N/runtime',
    ...
    const NS_CONST = {
        ACCOUNTS : {
            INTERCOMPANY_RECEIVABLE : 4257,
            INTERCOMPANY_PAYABLE : 4258,
            UNAPPLIED_CUSTOMER_DEBIT : 4255,
            UNAPPLIED_DEPOSIT : 1018,
            JPMC_CLEARING : 1309
        },
        LOCATION : {
             CORPORATE_CANADA : 280,
             OTHER_GA_USA : 318
        },
        SUBSIDIARY : {
            CANADA : 83,
    ...
    const getInputData = (context) => {
        try {
            ...
            const params = {
                search_id: script.getParameter('custscript_mr_payment_srch')
            };
    ...
    const createAdvJE = (data) =>{
        ...
        if(countryPulled == 'US'){
           ...
           const sublistOpts = { sublistId: "line", line: 0 };
            ...
            //line 1
            createAdvJE.selectNewLine({
                sublistId: 'line'
            });
            createAdvJE.setCurrentSublistValue({
                sublistId: 'line',
                fieldId: 'account',
                value: NS_CONST.ACCOUNTS.JPMC_CLEARING,
                //line: 0
            });
             createAdvJE.setCurrentSublistValue({
                sublistId: 'line',
            ...
            createAdvJE.setCurrentSublistValue({
                sublistId: 'line',
                fieldId: 'location',
                value: NS_CONST.LOCATION.CORPORATE_CANADA,
                //line: 0
            });
            createAdvJE.setCurrentSublistValue({
                sublistId: 'line',
        ...
        if(savedJE){
            log.audit('AUDIT createAdvJE savedJE', `saved JE with id ${savedJE}`);
            return savedJE;
        }
